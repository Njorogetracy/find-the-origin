...
let shuffledQuestions, currentQuestionShow

startButton.addEventListener("click", startQuiz)
quizLoad.addEventListener("load", setQuestion)
...
function setQuestion() {
  showQuestion(shuffledQuestions[currentQuestionShow])
}

function showQuestion(currentQuizQuestion) {
